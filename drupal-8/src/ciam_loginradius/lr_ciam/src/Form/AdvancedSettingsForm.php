...
class AdvancedSettingsForm extends ConfigFormBase {
  ...
  $form['lr_user_settings']['ciam_enable_remember_me'] = [
   ...
   $form['lr_user_settings']['ciam_email_verification_condition'] = [
    '#type' => 'radios',
  ...
  $form['lr_user_settings']['ciam_enable_login_on_email_verification'] = [
    '#type' => 'radios',
  ...
  $form['lr_user_settings']['ciam_enable_user_name'] = [
    '#type' => 'radios',
  ...
  $form['lr_user_settings']['ciam_ask_email_always_for_unverified'] = [
    '#type' => 'radios',
